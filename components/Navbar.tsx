...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-200 shadow-lg px-6 md:px-8 py-4 flex justify-between items-center">
      ...
      {/* Menú móvil */}
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-t border-gray-700 flex flex-col items-center py-6 gap-6 md:hidden animate-fadeIn">
          {sections.map((section) => (
            <ScrollLink
              key={section}
              to={section}
